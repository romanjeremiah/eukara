...
pricing: "$0.95 per M input tokens, $4.00 per M output tokens, $0.19 per M cached input tokens"
...
| **Pricing** | $0.95 per M input tokens, $4.00 per M output tokens, $0.19 per M cached input tokens |
| **License** | [View License](https://huggingface.co/moonshotai/Kimi-K2.7-Code/blob/main/LICENSE) |
| **Capabilities** | Function calling, Reasoning, Vision, Batch, Deprecated |
...
export default {
  async fetch(request, env): Promise<Response> {
    const response = await env.AI.run("@cf/moonshotai/kimi-k2.7-code", {
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/kimi-k2.7-code/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/moonshotai/kimi-k2.7-code)
