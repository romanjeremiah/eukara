...
pricing: "$0.60 per M input tokens, $3.00 per M output tokens, $0.10 per M cached input tokens"
license_url: "https://github.com/MoonshotAI/Kimi-K2.5/blob/master/LICENSE"
capabilities:
  - Function calling
  - Reasoning
  - Vision
...
| **Pricing** | $0.60 per M input tokens, $3.00 per M output tokens, $0.10 per M cached input tokens |
| **License** | [View License](https://github.com/MoonshotAI/Kimi-K2.5/blob/master/LICENSE) |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/kimi-k2.5/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/moonshotai/kimi-k2.5)
