...
task_type: "deepseek-r1-distill-qwen-32b 

Text Generation"
author: "DeepSeek"
context_window: "80,000 tokens"
pricing: "$0.50 per M input tokens, $4.88 per M output tokens"
...
| **Task Type** | deepseek-r1-distill-qwen-32b 

Text Generation |
| **Author** | DeepSeek |
| **Context Window** | 80,000 tokens |
| **Pricing** | $0.50 per M input tokens, $4.88 per M output tokens |
| **License** | [View License](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/LICENSE) |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/deepseek-r1-distill-qwen-32b/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/deepseek-ai/deepseek-r1-distill-qwen-32b)
