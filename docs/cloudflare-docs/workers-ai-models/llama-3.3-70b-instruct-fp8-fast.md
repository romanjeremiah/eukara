...
task_type: "3-70b-instruct-fp8-fast 

Text Generation"
author: "Meta"
context_window: "24,000 tokens"
pricing: "$0.29 per M input tokens, $2.25 per M output tokens"
license_url: "https://github.com/meta-llama/llama-models/blob/main/models/llama3%5F3/LICENSE"
capabilities:
  - Function calling
  - LoRA
  - Batch
...
| **Task Type** | 3-70b-instruct-fp8-fast 

Text Generation |
| **Author** | Meta |
| **Context Window** | 24,000 tokens |
| **Pricing** | $0.29 per M input tokens, $2.25 per M output tokens |
| **License** | [View License](https://github.com/meta-llama/llama-models/blob/main/models/llama3%5F3/LICENSE) |
| **Capabilities** | Function calling, LoRA, Batch |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/llama-3.3-70b-instruct-fp8-fast/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-3.3-70b-instruct-fp8-fast)
