...
task_type: "meta-llama-3-8b-instruct 
...
| Property | Value |
|----------|-------|
| **Model ID** | `@hf/meta-llama/meta-llama-3-8b-instruct` |
| **Task Type** | meta-llama-3-8b-instruct 
...
export default {
  async fetch(request, env): Promise<Response> {
    const response = await env.AI.run("@hf/meta-llama/meta-llama-3-8b-instruct", {
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/meta-llama-3-8b-instruct/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@hf/meta-llama/meta-llama-3-8b-instruct)
