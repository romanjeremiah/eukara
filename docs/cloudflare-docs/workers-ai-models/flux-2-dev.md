...
title: "flux-2-dev"
task_type: "flux-2-dev 

Text-to-Image"
author: "Black Forest Labs"
pricing: "$0.00021 per input 512x512 tile, per step, $0.00041 per output 512x512 tile, per step"
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/flux-2-dev/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/black-forest-labs/flux-2-dev)
