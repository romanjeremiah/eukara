...
| Property | Value |
|----------|-------|
| **Model ID** | `@cf/microsoft/phi-2` |
| **Task Type** | phi-2 Beta 
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/phi-2/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/microsoft/phi-2)
