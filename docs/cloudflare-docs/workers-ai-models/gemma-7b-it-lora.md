...
task_type: "gemma-7b-it-lora Beta 

Text Generation"
author: "Google"
context_window: "3,500 tokens"
capabilities:
  - LoRA
  - Beta
---
...
| **Task Type** | gemma-7b-it-lora Beta 

Text Generation |
| **Author** | Google |
| **Context Window** | 3,500 tokens |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/gemma-7b-it-lora/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/google/gemma-7b-it-lora)
