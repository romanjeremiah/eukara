...
pricing: "$0.017 per M input tokens, $0.11 per M output tokens"
capabilities:
  - Function calling
  - LoRA
---
...
| **Pricing** | $0.017 per M input tokens, $0.11 per M output tokens |
| **Capabilities** | Function calling, LoRA |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/granite-4.0-h-micro/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/ibm-granite/granite-4.0-h-micro)
