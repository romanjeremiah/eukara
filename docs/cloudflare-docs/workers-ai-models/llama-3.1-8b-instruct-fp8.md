...
task_type: "1-8b-instruct-fp8 

Text Generation"
author: "Meta"
context_window: "32,000 tokens"
pricing: "$0.15 per M input tokens, $0.29 per M output tokens"
...
| Property | Value |
|----------|-------|
| **Model ID** | `@cf/meta/llama-3.1-8b-instruct-fp8` |
| **Task Type** | 1-8b-instruct-fp8 
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/llama-3.1-8b-instruct-fp8/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-3.1-8b-instruct-fp8)
