...
task_type: "5-coder-32b-instruct 

Text Generation"
author: "Qwen"
context_window: "32,768 tokens"
pricing: "$0.66 per M input tokens, $1.00 per M output tokens"
capabilities:
  - LoRA
---
...
| **Task Type** | 5-coder-32b-instruct 
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/qwen2.5-coder-32b-instruct/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/qwen/qwen2.5-coder-32b-instruct)
