...
task_type: "nemotron-3-120b-a12b 

Text Generation"
author: "NVIDIA"
context_window: "256,000 tokens"
pricing: "$0.50 per M input tokens, $1.50 per M output tokens"
...
| **Task Type** | nemotron-3-120b-a12b 

Text Generation |
| **Author** | NVIDIA |
| **Context Window** | 256,000 tokens |
| **Pricing** | $0.50 per M input tokens, $1.50 per M output tokens |
| **License** | [View License](https://www.nvidia.com/en-us/agreements/enterprise-software/nvidia-nemotron-open-model-license/) |
...
export default {
  async fetch(request, env): Promise<Response> {
    const response = await env.AI.run("@cf/nvidia/nemotron-3-120b-a12b", {
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/nemotron-3-120b-a12b/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/nvidia/nemotron-3-120b-a12b)
