...
task_type: "2-lora Beta 

Text Generation"
author: "MistralAI"
context_window: "15,000 tokens"
capabilities:
  - LoRA
  - Beta
---
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/mistral-7b-instruct-v0.2-lora/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/mistral/mistral-7b-instruct-v0.2-lora)
