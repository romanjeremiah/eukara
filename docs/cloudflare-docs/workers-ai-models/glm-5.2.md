...
pricing: "$1.40 per M input tokens, $4.40 per M output tokens, $0.26 per M cached input tokens"
capabilities:
  - Function calling
  - Reasoning
  - Batch
...
| **Pricing** | $1.40 per M input tokens, $4.40 per M output tokens, $0.26 per M cached input tokens |
| **Capabilities** | Function calling, Reasoning, Batch, Deprecated |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/glm-5.2/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/zai-org/glm-5.2)
