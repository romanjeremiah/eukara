...
Text Embeddings"
author: "BAAI"
pricing: "$0.02 per M input tokens"
capabilities:
  - Batch
---
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/bge-small-en-v1.5/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/baai/bge-small-en-v1.5)
