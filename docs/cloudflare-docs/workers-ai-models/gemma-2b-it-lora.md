...
task_type: "gemma-2b-it-lora Beta 
...
| Property | Value |
|----------|-------|
| **Model ID** | `@cf/google/gemma-2b-it-lora` |
| **Task Type** | gemma-2b-it-lora Beta 

Text Generation |
| **Author** | Google |
| **Context Window** | 8,192 tokens |
| **Capabilities** | LoRA, Beta |
...
export default {
  async fetch(request, env): Promise<Response> {
    const response = await env.AI.run("@cf/google/gemma-2b-it-lora", {
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/gemma-2b-it-lora/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/google/gemma-2b-it-lora)
