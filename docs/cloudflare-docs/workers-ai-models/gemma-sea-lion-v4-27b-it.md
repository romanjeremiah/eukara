...
task_type: "gemma-sea-lion-v4-27b-it 
...
| Property | Value |
|----------|-------|
| **Model ID** | `@cf/aisingapore/gemma-sea-lion-v4-27b-it` |
| **Task Type** | gemma-sea-lion-v4-27b-it 

Text Generation |
| **Author** | aisingapore |
| **Context Window** | 128,000 tokens |
| **Pricing** | $0.35 per M input tokens, $0.56 per M output tokens |
| **Capabilities** | LoRA, Batch |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/gemma-sea-lion-v4-27b-it/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/aisingapore/gemma-sea-lion-v4-27b-it)
