...
task_type: "llama-3-8b-instruct-awq 

Text Generation"
author: "Meta"
deprecated: "5/30/2026"
context_window: "8,192 tokens"
pricing: "$0.12 per M input tokens, $0.27 per M output tokens"
...
| Property | Value |
|----------|-------|
| **Model ID** | `@cf/meta/llama-3-8b-instruct-awq` |
| **Task Type** | llama-3-8b-instruct-awq 
...
export default {
  async fetch(request, env): Promise<Response> {
    const response = await env.AI.run("@cf/meta/llama-3-8b-instruct-awq", {
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/llama-3-8b-instruct-awq/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-3-8b-instruct-awq)
