...
pricing: "$0.95 per M input tokens, $0.16 per M cached input tokens, $4.00 per M output tokens"
license_url: "https://huggingface.co/moonshotai/Kimi-K2.6/blob/main/LICENSE"
capabilities:
  - Function calling
  - Reasoning
  - Vision
...
| **Pricing** | $0.95 per M input tokens, $0.16 per M cached input tokens, $4.00 per M output tokens |
| **License** | [View License](https://huggingface.co/moonshotai/Kimi-K2.6/blob/main/LICENSE) |
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/kimi-k2.6/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/moonshotai/kimi-k2.6)
