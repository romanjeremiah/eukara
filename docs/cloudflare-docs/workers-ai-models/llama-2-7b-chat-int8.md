...
task_type: "llama-2-7b-chat-int8 
...
| **Task Type** | llama-2-7b-chat-int8 
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/llama-2-7b-chat-int8/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/meta/llama-2-7b-chat-int8)
