...
context_window: "2,824 tokens"
pricing: "$0.11 per M input tokens, $0.19 per M output tokens"
capabilities:
  - LoRA
  - Deprecated
---
...
- [Official Documentation](https://developers.cloudflare.com/workers-ai/models/mistral-7b-instruct-v0.1/)
- [Workers AI Overview](https://developers.cloudflare.com/workers-ai/)
- [LLM Playground](https://playground.ai.cloudflare.com/?model=@cf/mistral/mistral-7b-instruct-v0.1)
